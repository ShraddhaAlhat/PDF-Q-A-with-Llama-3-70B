...
def extract_content_from_pdfs(pdf_paths):  # Modified to accept multiple paths
    documents = []
...
def fast_rag_pipeline(pdf_paths, query, google_api_key, groq_api_key):  # Now accepts multiple paths
    # Configure APIs here
    genai.configure(api_key=google_api_key)
    
    # Process all PDFs together
    documents = extract_content_from_pdfs(pdf_paths)  # Use the modified function
